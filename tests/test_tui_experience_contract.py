...
class TestTuiExperienceContract(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.m = load_tui_module("authored_pack_tui_experience_contract")
    ...
    def test_assemble_card_summarizes_review_before_advanced_prompts(self) -> None:
    ...
    def test_assemble_enter_opens_inline_review_panel_without_prompt_ladder(self) -> None:
        m = self.m
        state = self._state()
    ...
    def test_assemble_panel_shortcuts_stay_in_panel_without_prompt_ladder(self) -> None:
        m = self.m
        state = self._state()
        state.selected = state.menu.index("Assemble")
    ...
    def test_assemble_panel_confirm_runs_assemble_from_config(self) -> None:
        m = self.m
        state = self._state()
        state.selected = state.menu.index("Assemble")
