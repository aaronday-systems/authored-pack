...
This is the one short honest demo for Authored Pack `v0.2.5`.
...
The canonical demo verifies the emitted ZIP path reported by `assemble`; it does not substitute a directory-only verification.
